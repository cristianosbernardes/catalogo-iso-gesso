...
// Recharts é carregado sob demanda (~200KB gzip) — só entra no bundle
// quando o produto tiver curva de absorção para renderizar.
const AbsorptionAreaChart = dynamic(
  () => import('./absorption-area-chart'),
  {
    ssr: false,
    loading: () => (
      <div className="h-[200px] w-full rounded-lg bg-muted/30 animate-pulse" />
    ),
  }
)
